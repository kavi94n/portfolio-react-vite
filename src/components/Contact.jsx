  ...
  return (
   ...
   >
    ...
    <div class="max-w-4xl mx-auto p-6  bg-white shadow-lg rounded-lg mb-8">
        <h1 class="text-3xl font-semibold font-Nuni text-center mb-4 text-gray-800"><strong>Me contecter</strong></h1>
        ...
        <div class="flex flex-col m-4 md:flex-row md:justify-between space-y-8 md:space-y-0 md:space-x-8 ">
            ...
            <div class="w-full md:w-1/2 font-Nuni">
            <h2 className="text-3xl font-semibold mb-4"><strong>Mes coordonnées</strong></h2>
          <p className="mb-2 font-normal">210 Avenue du 8 mai 1945, 93150 le blanc mesnil</p>
          <p className="mb-2 font-normal">Téléphone: 06 05 69 85 61</p>
                <iframe
